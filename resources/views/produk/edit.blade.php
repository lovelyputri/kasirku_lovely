            ...
            <div class="card p-4">
                ...
                <form action="{{ route('produk.update', $produk) }}" method="POST" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="harga" min="0" class="form-control @error('harga') is-invalid @enderror" value="{{ old('harga', $produk->harga) }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="stok" min="0" class="form-control @error('stok') is-invalid @enderror" value="{{ old('stok', $produk->stok) }}" required>
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-perbarui">Perbarui</button>
